...
import "./Hero.css";
import { Link } from "react-router-dom";
import brandImage from "../assets/bgr.png"; // Add your brand image here
...
function Hero() {
      ...
      for (let a = 0; a < particles.length; a++) {
        for (let b = a; b < particles.length; b++) {
          ...
          if (distance < 12000) {
            ...
            ctx.strokeStyle = `rgba(180,220,255,${opacity * 0.12})`;
            ctx.lineWidth = 1;
            ctx.beginPath();
    ...
    const connectToCursor = () => {
      ...
      particles.forEach((particle) => {
        ...
        if (distance < mouse.radius) {
          ...
          ctx.strokeStyle = `rgba(180,220,255,${opacity * 0.45})`;
          ctx.lineWidth = 1.2;
          ctx.beginPath();
          ...
          particles.forEach((other) => {
            ...
            if (dist2 < 90) {
              ...
              ctx.closePath();
              ctx.fillStyle = `rgba(120,180,255,${opacity * 0.03})`;
              ctx.fill();
            }
          });
        }
  ...
  return (
    <section className="hero" ref={heroRef}>
      ...
      <div 
        ref={cursorRef} 
        className={`custom-cursor ${isHovering || isBrandHovering ? 'cursor-hover' : ''}`}
      >
        <div className="cursor-dot" />
        <div className="cursor-ring" />
      </div>
      ...
      {/* CINEMATIC HUD MESH */}
      <canvas ref={canvasRef} className="hero-mesh" />
          ...
          <div className="hero-visual">
            ...
            >
              <div className="sculpture-inner">
                ...
                {/* =====================================================
                    BRAND IMAGE CARD (Overlay on glass sculpture)
                ====================================================== */}
                <div 
                  className={`brand-card ${isBrandHovering ? 'brand-card-hover' : ''}`}
                ...
                >
                  <div className="brand-card-inner">
                    ...
                    />
                    <div className="brand-card-reflection" />
                    <div className="brand-card-glow" />
                  </div>
                  <div className="brand-card-shimmer" />
                  <div className="brand-card-badge">
