...
function WhyChoose() {
  ...
  const cards = [
    ...
    {
      image:
        "https://images.pexels.com/photos/14437601/pexels-photo-14437601.jpeg",
      title: "Fastest Delivery",
      text:
        "Precision logistics systems engineered for ultra-fast nationwide delivery performance.",
    },

    {
      ...
      title: "PAN India Network",
      text:
        "Connected premium distribution infrastructure serving projects across every region.",
    },

    {
      ...
      title: "AI Precision Systems",
      text:
        "Laser-guided fabrication delivering architectural perfection at microscopic tolerances.",
    },

    {
      ...
      title: "500+ Smart Variants",
      text:
        "Future-ready glass ecosystems for luxury architecture and intelligent interiors.",
    },
  ...
  return (
    ...
    >
      ...
      <div className="wc-bg">
        ...
        <img
          src="https://images.pexels.com/photos/19136569/pexels-photo-19136569.jpeg"
          alt=""
        />
