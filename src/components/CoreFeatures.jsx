...
// <div className="nx-cinematic-bg">

//   <div className="nx-building building-1"></div>

//   <div className="nx-building building-2"></div>

//   <div className="nx-building building-3"></div>

//   <div className="nx-reflection reflection-1"></div>

//   <div className="nx-reflection reflection-2"></div>

//   <div className="nx-reflection reflection-3"></div>

//   <div className="nx-orb orb-1"></div>

//   <div className="nx-orb orb-2"></div>

//   <div className="nx-grid"></div>
        ...
        <div className="nx-item">
          ...
          <div className="nx-content">
            ...
            <p>
              ...
              AI-enhanced fabrication systems
              engineered for architectural
              perfection, luxury aesthetics,
              and next-generation execution.
        ...
        <div className="nx-item">
          ...
          <div className="nx-content">
            ...
            <h3>
              ...
              Cinematic Architectural Experiences

            </h3>

            <p>

              Transforming modern environments
              through immersive premium
              glass ecosystems and refined
              spatial aesthetics.
